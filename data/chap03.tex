...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/chap03_label.png}
    \caption{动态骨显像的数据标注}
...
\begin{figure}[htbp]
    \centering
    \subfloat{
        \includegraphics[width=0.33\textwidth]{figures/chap03_ROC_knee.png}
    }
    \subfloat{
        \includegraphics[width=0.33\textwidth]{figures/chap03_CC_knee.png}
    }
    \subfloat{
        \includegraphics[width=0.33\textwidth]{figures/chap03_DAC_knee.png}
    }
    \newline
    \newline
    \subfloat{
        \includegraphics[width=0.33\textwidth]{figures/chap03_ROC_hip.png}
    }
    \subfloat{
        \includegraphics[width=0.33\textwidth]{figures/chap03_CC_hip.png}
    }
    \subfloat{
        \includegraphics[width=0.33\textwidth]{figures/chap03_DAC_hip.png}
    }
